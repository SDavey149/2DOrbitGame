...
public class CircleTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        object2 = new GameObject(new Vector2D(5,5));
        ...
        object2.setVelocity(new Vector2D(-1,-1));
    ...
    public void testOverlaps() throws Exception {
        ...
        assertEquals(false, object2.getShape().overlaps(object3.getShape()));
        object2.getPosition().set(2, 2);
        assertEquals(true, object2.getShape().overlaps(object3.getShape()));
    }
